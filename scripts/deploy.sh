...
nohup java -jar -Dspring.config.location=classpath:/application.yml,/home/ec2-user/app/jiok-service/Purchase/application-db.yml $JAR_NAME > $REPOSITORY/nohup.out 2>&1 &
